...
public class ShowCaseLayout extends FrameLayout {
    ...
    public void showTutorial(View view,
        ...
        if (skipButton != null){
            if (hasSkipWord){
                skipButton.setImageDrawable(skipDrawable);
        ...
        if (nextButton != null) {
            if (isLast) {
                nextButton.setImageDrawable(finishDrawable);
    ...
    private void applyAttrs(Context context, @Nullable ShowCaseBuilder builder) {
        ...
        this.prevDrawable = ContextCompat.getDrawable(context, R.drawable.ic_button_prev);
        this.nextDrawable = ContextCompat.getDrawable(context, R.drawable.ic_button_next);
        this.finishDrawable = ContextCompat.getDrawable(context, R.drawable.ic_button_finish);
        this.skipDrawable = ContextCompat.getDrawable(context, R.drawable.ic_button_skip);

        this.lineColorRes = ContextCompat.getColor(context,R.color.blue);
        ...
        this.lineColorRes = builder.getLineColorRes() != 0 ?
        ...
        this.prevDrawable = builder.getPrevDrawableRes() != 0 ?
                getResources().getDrawable(builder.getPrevDrawableRes())
                : this.prevDrawable;

        this.nextDrawable = builder.getNextDrawableRes() != 0 ?
                getResources().getDrawable(builder.getNextDrawableRes())
                : this.nextDrawable;

        this.finishDrawable = builder.getFinishDrawableRes() != 0 ?
                getResources().getDrawable(builder.getFinishDrawableRes())
                : this.finishDrawable;

        this.skipDrawable = builder.getSkipDrawableRes() != 0 ?
                getResources().getDrawable(builder.getSkipDrawableRes())
                : this.skipDrawable;
    ...
    private void initContent(Context context, ShowCaseBuilder builder) {
        ...
        int iv_previous = getResources().getIdentifier("iv_prev", "id", (builder.getPackageName() != null) ? builder.getPackageName() : context.getPackageName());
        int iv_skip = getResources().getIdentifier("iv_skip", "id", (builder.getPackageName() != null) ? builder.getPackageName() : context.getPackageName());
        int iv_next = getResources().getIdentifier("iv_next", "id", (builder.getPackageName() != null) ? builder.getPackageName() : context.getPackageName());
        ...
        if (line != null) {
            line.setBackgroundColor(lineColorRes);
        }

        prevButton = (ImageView) viewGroupTutorContent.findViewById(iv_previous);
        nextButton = (ImageView) viewGroupTutorContent.findViewById(iv_next);
        skipButton = (ImageView) viewGroupTutorContent.findViewById(iv_skip);
        ...
        if (prevButton != null) {
            ...
            prevButton.setOnClickListener(v -> {
                if (showCaseListener != null) ShowCaseLayout.this.showCaseListener.onPrevious();
            });
        }
        if (nextButton != null) {
            nextButton.setImageDrawable(nextDrawable);
        ...
        if (skipButton != null){
            ...
            skipButton.setOnClickListener(view -> {
                if (showCaseListener != null) ShowCaseLayout.this.showCaseListener.onComplete();
            });
        }
